...
<div class="flex flex-col justify-center flex-grow font-dmsans lg:bg-red-500 md:bg-yellow-500 bg-green-500">
    <div class="flex flex-col items-center mx-auto py-4 w-11/12 lg:w-6/12 md:8/12 bg-white shadow-lg rounded-md">
        ...
        <div class="w-5/6 text-center">
            ...
            <form action="/webAlumni/register/success">
                <!-- name -->
                ...
                <div class="flex w-full items-center  mb-4">
                    ...
                    <div class=" flex justify-end md:justify-between w-full ">
                        ...
                        <!-- tombol register -->
                        <!-- Catatan : kalau register sukses bakal masuk ke halaman "http://localhost/webAlumni/register/success" -->
                        ...
                        <a href="">
                            <div class="flex py-2 px-1 md:px-4 my-auto border-2 border-blue-500 rounded-lg hover:border-blue-700 hover:bg-blue-100">
                                <img src="/webAlumni/public/img/search.png" alt="" class="w-4 h-4 my-auto">
