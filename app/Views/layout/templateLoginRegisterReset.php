...
<head>
    ...
    <link href="/webAlumni/public/css/output.css" rel="stylesheet">
...
<body>
            ...
            <div class="mx-6 block md:flex justify-between">
                <div class="flex flex-grow justify-between md:justify-start ">
                    <div class="flex ">
                        ...
                        <!-- logo polstat stis -->
                        <img src="/webAlumni/public/img/STISlogo.png" alt="" class="rounded-full w-12 h-12 my-auto md:w-16 md:h-16">
                        <!-- logo polstat stis -->
                ...
                <div class="block md:flex my-auto md:my-auto hidden" id="submenu">
                    <div class="text-xs md:text-base font-semibold text-center mx-4 mt-1 md:mt-0 py-1 px-2 hover:bg-gray-100 <?= $Login ?>"> <a href="/webAlumni/login"> Login </a></div>
                    <div class="text-xs md:text-base font-semibold text-center mx-4 mt-1 md:mt-0 py-1 px-2 hover:bg-gray-100 <?= $Register ?>"> <a href="/webAlumni/register"> Register </a></div>
                </div>
            </div>
        </div>
        <!-- navbar -->
    ...
    <script src="/webAlumni/public/js/navbar.js"></script>
